...
public class TabletPanelController : MonoBehaviour
{
    ...
    [Header("SFX")]
    [SerializeField] private AudioSource sfxSource;    // 2D AudioSource
    ...
    // we’ll restore the player’s previous cursor state when closing
    ...
    void Awake()
    {
        ...
        if (sfxSource)
        {
            ...
            sfxSource.spatialBlend = 0f; // play as pure 2D UI sound
        }
    }
    ...
    void Update()
    {
        ...
        // Close key (if assigned) takes priority
    ...
    public void Open()
    {
        ...
        // remember cursor state so we can restore it
    ...
    // Hook this to your “Close Tablet Screen” button
    ...
    bool IsPointerOverUI()
    {
        ...
        // Works for StandaloneInputModule and default UI
